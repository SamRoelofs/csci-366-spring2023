...
void lmsm_i_jal(lmsm *our_little_machine) {
    int cmd = our_little_machine->program_counter;
    ...
    our_little_machine->memory[our_little_machine->return_address_pointer] = cmd;
}
...
void lmsm_i_sadd(lmsm *our_little_machine) {
    ...
    int term1 = our_little_machine->memory[our_little_machine->stack_pointer + 1];
    int term2 = our_little_machine->memory[our_little_machine->stack_pointer];

    our_little_machine->stack_pointer++;
    our_little_machine->memory[our_little_machine->stack_pointer] = term1 + term2;

    int * ptr;
    ptr = &our_little_machine->memory[our_little_machine->stack_pointer];
    lmsm_cap_value(ptr);
}
...
void lmsm_i_smax(lmsm *our_little_machine) {
    ...
    int max = -999;
    while(our_little_machine->stack_pointer < 200){
        if (our_little_machine->memory[our_little_machine->stack_pointer] > max){
            max = our_little_machine->memory[our_little_machine->stack_pointer];
        }
        our_little_machine->stack_pointer++;
    }

    our_little_machine->stack_pointer = 199;
    our_little_machine->memory[our_little_machine->stack_pointer] = max;
}
...
void lmsm_i_smin(lmsm *our_little_machine) {
    ...
    int min = 999;
    while(our_little_machine->stack_pointer < 200){
        if (our_little_machine->memory[our_little_machine->stack_pointer] < min){
            min = our_little_machine->memory[our_little_machine->stack_pointer];
        }
        our_little_machine->stack_pointer++;
    }

    our_little_machine->stack_pointer = 199;
    our_little_machine->memory[our_little_machine->stack_pointer] = min;
}
...
void lmsm_i_out(lmsm *our_little_machine) {
    ...
    char out[4];
    sprintf(out, "%d ", our_little_machine->accumulator);
...
void lmsm_i_add(lmsm *our_little_machine, int location) {
    ...
    int * ptr;
    ptr = &our_little_machine->accumulator;
    lmsm_cap_value(ptr);
}
